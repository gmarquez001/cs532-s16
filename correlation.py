...
if __name__ == '__main__':
	dataList,userList,itemList = read_data_files(dataName='C:/Python27/AS7/src/data_files/u.data',itemName='C:/Python27/AS7/src/data_files/u.item',userName='C:/Python27/AS7/src/data_files/u.user')
